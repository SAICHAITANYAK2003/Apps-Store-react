...
class AppStore extends Component {
  ...
  getSearchResults = () => {
    ...
    const seachResults = appsList.filter(eachApp =>
  ...
  render() {
    ...
    const seachResults = this.getSearchResults()
    const filterApps = this.getActiveTabId(seachResults)
    ...
    return (
      <div className="main-container">
        ...
        <ul className="tablist-section-container">
          {tabsList.map(eachTab => (
            <TabItem
              key={eachTab.tabId}
              className="tab-items"
              eachTab={tabsList.tabId}
              tabDetails={eachTab}
